...
import com.brightsight.joker.core.Config.Value.BETA_CHANNEL
import com.brightsight.joker.core.Config.Value.CANARY_CHANNEL
import com.brightsight.joker.core.Config.Value.CUSTOM_CHANNEL
import com.brightsight.joker.core.Config.Value.DEFAULT_CHANNEL
import com.brightsight.joker.core.Config.Value.STABLE_CHANNEL
import com.brightsight.joker.core.Const
import com.brightsight.joker.core.Info
import com.brightsight.joker.data.network.*
...
class NetworkService(
    ...
    private suspend fun fetchMainVersion() = api.fetchBranch(JOKER_MAIN, "master").commit.sha
}
