...
import com.brightsight.joker.core.utils.refreshLocale
import com.brightsight.joker.data.preference.PreferenceModel
import com.brightsight.joker.data.repository.DBConfig
import com.brightsight.joker.di.ServiceLocator
import com.brightsight.joker.ui.theme.Theme
...
object Config : PreferenceModel, DBConfig {
    ...
    object Key {
        ...
        // system state
        const val JOKERHIDE = "magiskhide"
    }
    ...
    var magiskHide by preference(Key.JOKERHIDE, true)
