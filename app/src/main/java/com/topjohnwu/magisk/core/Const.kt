...
object Const {
    ...
    // Paths
    lateinit var JOKERTMP: String
    val JOKER_PATH get() = "$JOKERTMP/modules"
    const val TMPDIR = "/dev/tmp"
    const val JOKER_LOG = "/cache/magisk.log"
    ...
    object ID {
        ...
        const val CHECK_JOKER_UPDATE_WORKER_ID = "magisk_update"
    }
